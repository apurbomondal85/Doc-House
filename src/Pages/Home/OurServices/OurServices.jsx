        ...
        <div className='container py-28'>
            <div className="md:flex justify-center items-center gap-6">
                <div className="flex-1">
                    <img className='h-[900px] w-[558px]' src={serviceImg} alt="services image" />
                </div>
                <div className="flex-1 space-y-4">
                    ...
                    <button type="button" class="text-[#F7A582] hover:text-white bg-transparent transition-colors hover:bg-[#F7A582]  border border-[#F7A582] font-medium rounded-lg text-sm px-5 py-2.5">More Details</button>
                </div>
            </div>
        </div>
    )
