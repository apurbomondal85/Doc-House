...
function DoctorCart({ doctor }) {
    const { name, image, price, graduation, rating, location, available } = doctor;
    return (
        <div className="bg-white rounded-lg shadow p-4 overflow-hidden">
            ...
            <div>
            <button type="button" className="text-[#F7A582] border border-[#F7A582] transition ease-in-out delay-150 hover:text-white hover:bg-[#F7A582] w-full font-medium rounded-lg py-3 mt-4 focus:outline-none">All Service</button>
            </div>
        </div>
    )
}
